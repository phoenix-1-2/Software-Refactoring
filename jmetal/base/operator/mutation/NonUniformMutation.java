...
/**
 * This class implements a non-uniform mutation operator. NOTE: the type of the
...
public class NonUniformMutation extends Mutation
{
	...
	/**
	 * actualIteration_ stores the iteration in which the operator is going to
	 * be applied
	 */
	...
	public Object execute(Object object) throws JMException
	{
		...
		if (probability == null)
		{
			Configuration.logger_.severe("NonUniformMutation.execute: probability " + "not specified");
			Class<?> cls = java.lang.String.class;
			String name = cls.getName();
			throw new JMException("Exception in " + name + ".execute()");
		}
