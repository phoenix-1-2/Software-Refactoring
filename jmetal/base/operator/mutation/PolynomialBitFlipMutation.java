...
public class PolynomialBitFlipMutation extends Mutation
{
	...
	public Object execute(Object object) throws JMException
	{
		...
		{
			Configuration.logger_.severe("PolynomialBitFlipMutation.execute: probability of the real component" + "not specified");
			Class<?> cls = java.lang.String.class;
			String name = cls.getName();
			throw new JMException("Exception in " + name + ".execute()");
		}
		...
		{
			Configuration.logger_.severe("PolynomialBitFlipMutation.execute: probability of the binary component" + "not specified");
			Class<?> cls = java.lang.String.class;
			String name = cls.getName();
			throw new JMException("Exception in " + name + ".execute()");
		}
		...
		// System.out.println("RP: " + realProbability + "\tBP: " +
		// binaryProbability) ;
