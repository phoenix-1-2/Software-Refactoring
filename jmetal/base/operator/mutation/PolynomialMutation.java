...
/**
 * This class implements a polynomial mutation operator. NOTE: the operator is
 * applied to Real solutions, so the type of the solutions must be
 * </code>SolutionType_.Real</code>. NOTE: if you use the default constructor,
 * the value of the etc_m parameter is ETA_M_DEFAULT_. You can change it using
 * the parameter "distributionIndex" before invoking the execute() method -- see
 * lines 116-119
 */
public class PolynomialMutation extends Mutation
{
	...
	public Object execute(Object object) throws JMException
	{
		...
		if ((solution.getType().getClass() != REAL_SOLUTION) && (solution.getType().getClass() != ARRAY_REAL_SOLUTION))
		{
		...
		if (probability == null)
		{
			Configuration.logger_.severe("PolynomialMutation.execute: probability " + "not specified");
			Class<?> cls = java.lang.String.class;
			String name = cls.getName();
			throw new JMException("Exception in " + name + ".execute()");
		}
