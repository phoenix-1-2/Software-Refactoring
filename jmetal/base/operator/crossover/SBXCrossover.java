 ...
 * solutions. NOTE: the operator is applied to Real solutions, so the type of
 * the solutions must be </code>SolutionType_.Real</code>. NOTE: if you use the
 * default constructor, the value of the etc_c parameter is
...
public class SBXCrossover extends Crossover
{
	...
	public Object execute(Object object) throws JMException
	{
		...
		if (((parents[0].getType().getClass() != REAL_SOLUTION) && (parents[1].getType().getClass() != REAL_SOLUTION)) && ((parents[0].getType().getClass() != ARRAY_REAL_SOLUTION) && (parents[1].getType().getClass() != ARRAY_REAL_SOLUTION)))
		{
