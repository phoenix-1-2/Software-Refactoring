 ...
 * solutions, and the type of the solutions must be binary (e.g.,
 * <code>SolutionType_.Binary</code> or <code>SolutionType_.BinaryReal</code>.
 */
public class HUXCrossover extends Crossover
{
	...
	public Object execute(Object object) throws JMException
	{
		...
		if (((parents[0].getType().getClass() != BINARY_SOLUTION) || (parents[1].getType().getClass() != BINARY_SOLUTION)) && ((parents[0].getType().getClass() != BINARY_REAL_SOLUTION) || (parents[1].getType().getClass() != BINARY_REAL_SOLUTION)))
		{
		...
		{
			Configuration.logger_.severe("HUXCrossover.execute: probability not " + "specified");
			Class<?> cls = java.lang.String.class;
			String name = cls.getName();
			throw new JMException("Exception in " + name + ".execute()");
		}

		Solution[] offSpring = doCrossover(probability.doubleValue(), parents[0], parents[1]);
