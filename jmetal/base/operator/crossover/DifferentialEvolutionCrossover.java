...
public class DifferentialEvolutionCrossover extends Crossover
{
	...
	/**
	 * ARRAY_REAL_SOLUTION represents class
	...
	public Object execute(Object object) throws JMException
	{
		...
		if (((parent[0].getType().getClass() != REAL_SOLUTION) && (parent[1].getType().getClass() != REAL_SOLUTION) && (parent[2].getType().getClass() != REAL_SOLUTION)) && ((parent[0].getType().getClass() != ARRAY_REAL_SOLUTION) && (parent[1].getType().getClass() != ARRAY_REAL_SOLUTION) && (parent[2].getType().getClass() != ARRAY_REAL_SOLUTION)))
		{
		...
		else if ((DE_Variant_.compareTo("current-to-rand/1") == 0) || (DE_Variant_.compareTo("current-to-best/1") == 0))
		{
			for (int j = 0; j < numberOfVariables; j++)
			{
				double value;
		...
		else if ((DE_Variant_.compareTo("current-to-rand/1/bin") == 0) || (DE_Variant_.compareTo("current-to-best/1/bin") == 0))
		{
			for (int j = 0; j < numberOfVariables; j++)
			{
				if (PseudoRandom.randDouble(0, 1) < CR_ || j == jrand)
		...
		else if ((DE_Variant_.compareTo("current-to-rand/1/exp") == 0) || (DE_Variant_.compareTo("current-to-best/1/exp") == 0))
		{
			CR = CR_;
			for (int j = 0; j < numberOfVariables; j++)
			{
		...
		{
			Configuration.logger_.severe("DifferentialEvolutionCrossover.execute: " + " unknown DE variant (" + DE_Variant_ + ")");
