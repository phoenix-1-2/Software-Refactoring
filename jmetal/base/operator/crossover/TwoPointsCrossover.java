 ...
 * solutions, and the type of the solutions must be
 * <code>SolutionType_.Permutation</code>.
 */
public class TwoPointsCrossover extends Crossover
{

	/**
	 * PERMUTATION_SOLUTION represents class
	 * jmetal.base.solutionType.PermutationSolutionType
	 */
	...
	public Object execute(Object object) throws JMException
	{
		...
		{
			Configuration.logger_.severe("TwoPointsCrossover.execute: probability not " + "specified");
			Class<?> cls = java.lang.String.class;
			String name = cls.getName();
			throw new JMException("Exception in " + name + ".execute()");
		}
