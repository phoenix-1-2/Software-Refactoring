 ...
 * International Journal of Intelligent Systems. Vol.24, No. 7 (July 2009), pp.
 * 726-746
 */
public class sMOCell1 extends Algorithm
{
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException
	{
		...
		Comparator<Solution> dominance = new DominanceComparator(), crowding = new CrowdingComparator();
		...
		while (evaluations < maxEvaluations)
		{
			...
			for (int ind = 0; ind < currentSolutionSet.size(); ind++)
			{
				...
				// neighbors[ind] =
				// neighborhood.getFourNeighbors(currentSolutionSet,ind);
				...
				// Create a new solution, using genetic operators mutation and
				// crossover
				...
				{ // Both two are non-dominates
					...
					// neighbors[ind].sort(new
					// FitnessAndCrowdingDistanceComparator()); //Create a new
					// comparator;
