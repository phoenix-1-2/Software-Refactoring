...
public abstract class Settings_gui extends Settings
{
	 ...
	 */
	public Algorithm configure(Properties settings, Problem problem) throws JMException, IllegalArgumentException, IllegalAccessException, ClassNotFoundException
	{
		problem_ = problem;
