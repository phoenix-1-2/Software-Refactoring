...
public class RWilcoxon
{
	 ...
	 */
	public static void generateScripts(String[] problems, String prefix, Experiment experiment) throws FileNotFoundException, IOException
	{
		...
		for (int indicator = 0; indicator < experiment.indicatorList_.length; indicator++)
		{
			...
			// "  write(\"\\\\begin{tabular}{" + latexTabularAlignment +
			// "}\", \"" + texFile + "\", append=TRUE)" + "\n" +
			...
			if ((Boolean) experiment.indicatorMinimize_.get(experiment.indicatorList_[indicator]) == true)
			{// minimize by default
			...
			// The tabular environment and the latexTableFirstLine variable must
			// be redefined
			latexTabularAlignment = "| l | ";
